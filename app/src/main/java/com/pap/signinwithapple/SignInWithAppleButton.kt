...
class SignInWithAppleButton @JvmOverloads constructor(
    ...
    init {
        val attributes = context.theme.obtainStyledAttributes(attrs, R.styleable.SignInWithAppleButton, 0, R.style.SignInWithAppleButton)
        ...
        textView.text = resources.getString(R.string.sign_in_with_apple_button_signInWithApple)
    }
